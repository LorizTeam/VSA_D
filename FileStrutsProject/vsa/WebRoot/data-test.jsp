		        ...
		        <!-- cut 9 pic -->
		        	<div class="swiper-slide">
		       		...
		       		<!-- 1project -->
		            	...
		            	<div id="1" class=" uk-overlay uk-overlay-hover gallery-img">
		            		        
							<img class="uk-overlay-scale" src="images/project/1.jpg"style=" height:100%; -webkit-transform:scale(1.8,1.2);">	
