...
<html>
<head>
<title>Frederick a Fashion category Flat bootstrap Responsive  Website Template | Typrography :: w3layouts</title>
				...
				<div class="navbar-header">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					  <ul class="nav navbar-nav">
						...
						<li class="active"><a href="typography.jsp">Typrography</a></li>
