...
<br><br>
	...
	<article class=" artic container "id="project">
		...
		<section class="uk-grid"  data-uk-grid="{controls: '#fillpro',gutter:0.1}">
			...
			class="uk-width-small-1-2 uk-width-medium-1-4 uk-overlay uk-overlay-hover">		
				 ...
				 <figcaption class="uk-overlay-panel uk-flex uk-flex-center uk-flex-middle uk-text-center uk-overlay-background">corporate</figcaption>
				</a>		
			</figure>	
			...
			class="uk-width-small-1-2 uk-width-medium-1-4 uk-overlay uk-overlay-hover">		
				 ...
				 <figcaption class="uk-overlay-panel uk-flex uk-flex-center uk-flex-middle uk-text-center uk-overlay-background">residential</figcaption>
				</a>		
			</figure>	
			...
			class="uk-width-small-1-2 uk-width-medium-1-4 uk-overlay uk-overlay-hover">		
				 ...
				 <figcaption class="uk-overlay-panel uk-flex uk-flex-center uk-flex-middle uk-text-center uk-overlay-background">commercial</figcaption>
				</a>		
			</figure>	
	...
	<div class="block"id="contact">
		...
		<div class="uk-text-center">
			...
			<br>
			<h2>+66(0)2  618  4318 <br><br> wvs2556@gmail.com</h2>
		</div>
		<br>
		<br><br>
		<div class=" uk-grid ">
